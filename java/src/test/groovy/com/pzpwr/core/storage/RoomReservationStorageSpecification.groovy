...
class RoomReservationStorageSpecification extends Specification {
    ...
    def "When adding new RoomReservation in same time then com.pzpwr.core.exception thrown"() {
        setup:
        uut.add(ROOM_RESERVATION_0)
    ...
    def "When release reservation then no com.pzpwr.core.exception thrown"() {
        setup:
        uut.add(ROOM_RESERVATION_0)
    ...
    def "When release not existing reservation then com.pzpwr.core.exception thrown"() {
        when:
        uut.release(ROOM_RESERVATION_0)
